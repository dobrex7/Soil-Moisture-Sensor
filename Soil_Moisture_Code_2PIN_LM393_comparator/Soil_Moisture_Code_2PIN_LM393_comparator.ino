...
void loop() {
  ...
  int procentVlage = map(vrednostSenzorja, 500, 1018, 100, 0); //500 je max vrednost, ko je 100% in 1018 min vrednost, ko je 0% 
 
 if(vrednostSenzorja<=500) //if pogoj, ki fiksira, vlažnost na 100%, če dobi vrednost pod 500, kar je avtomatsko max vlažnost
